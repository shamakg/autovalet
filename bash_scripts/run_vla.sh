...
export PYTHONPATH="${AUTOVALET_ROOT}:${CARLA_ROOT}:${SCENARIO_RUNNER_ROOT}:${LEADERBOARD_ROOT}:${SIMLINGO_TRAINING}:${SIMLINGO_TEAM_CODE}:${PYTHONPATH}"
...
# ln -sf /home/shamakg/carla_garage/leaderboard/leaderboard/autovalet/vla_adapter/model/pretrained/InternVL2-1B/* /tmp/hf_cache/hub/models--OpenGVLab--InternVL2-1B/snapshots/0d75ccd166b1d0b79446ae6c5d1a4a667f1e6187/
...
# python3 '/home/shamakg/carla_garage/leaderboard/leaderboard/autovalet/vla_adapter/benchmark.py' --mode COLLIDE
