...
if [ ! -e pretrained ]; then
    ln -sf /home/sumesh/carla_garage/leaderboard/leaderboard/autovalet/vla_adapter/model/pretrained pretrained
fi

export CARLA_ROOT=/home/sumesh/opt/carla
export PYTHONPATH=$PYTHONPATH:$CARLA_ROOT/PythonAPI/carla
export PYTHONPATH=$PYTHONPATH:/home/sumesh/carla_garage/Bench2Drive/leaderboard
export PYTHONPATH=$PYTHONPATH:/home/sumesh/carla_garage/Bench2Drive/scenario_runner
export PYTHONPATH=$PYTHONPATH:$SIMLINGO
export PYTHONPATH=$PYTHONPATH:$SIMLINGO/team_code
export SCENARIO_RUNNER_ROOT=/home/sumesh/carla_garage/Bench2Drive/scenario_runner
...
EVALUATOR=/home/sumesh/carla_garage/Bench2Drive/leaderboard/leaderboard/leaderboard_evaluator.py
...
if [ "$MODE" = "devtest" ]; then
    ...
    run_routes \
        /home/sumesh/carla_garage/leaderboard/data/routes_devtest.xml \
    ...
    SPLIT_DIR=/home/sumesh/carla_garage/leaderboard/data/bench2drive_split
    count=0
