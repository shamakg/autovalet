...
class ParkingScenario(BasicScenario):
    ...
    def __init__(self, world, config, destination, parked, ped_direction = 270, spawn_locations = [], debug_mode=0, criteria_enable=True):
        ...
        self.direction = ped_direction
        self.spawn_locations = spawn_locations

        self.other_actors = []
        
        self.DISTANCE_TRIGGER = 5.0
    ...
    def load_door_open(self, ego_location):
        ...
        self.world.debug.draw_point(
            door_car.get_location(), size=0.5, color=carla.Color(255, 0, 0), life_time=self.timeout
        )
    ...
    def load_cut_in(self, ego_location):
        ...
        self.world.debug.draw_point(
            cut_in_car.get_location(), size=0.5, color=carla.Color(255, 0, 0), life_time=self.timeout
        )
    ...
    def _create_behavior(self):
        ...
        behavior.add_child(ScenarioTimeout(60, self.config.name)) ## In case it times out
